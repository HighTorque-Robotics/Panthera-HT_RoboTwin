...
class ACT:
    ...
    def __init__(self, args_override=None, RoboTwin_Config=None):
        ...
        self.state_dim = getattr(RoboTwin_Config, "action_dim", 14)
        self.camera_names = args_override.get(
        ...
        if ckpt_dir:
            ...
            # Load the selected policy checkpoint. The best validation checkpoint
            # is the default for evaluation; callers can still override it.
            checkpoint_name = args_override.get("checkpoint_name", "policy_best.ckpt")
