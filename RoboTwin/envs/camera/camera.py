...
class Camera:
    ...
    def load_camera(self, scene):
        ...
        if self.collect_wrist_camera:
            ...
            if self.single_arm_mode:
                self.wrist_camera = scene.add_camera(
                    name="wrist_camera",
    ...
    def update_wrist_camera(self, left_pose, right_pose=None):
        ...
        if self.collect_wrist_camera:
            if self.single_arm_mode:
                self.wrist_camera.entity.set_pose(left_pose)
            else:
                if right_pose is None:
                    raise ValueError("Dual-arm wrist camera update requires right_pose")
    ...
    def get_config(self) -> dict:
        ...
        if self.collect_wrist_camera:
            if self.single_arm_mode:
                res["wrist_camera"] = _get_config(self.wrist_camera)
            else:
    ...
    def get_rgba(self) -> dict:
        ...
        if self.collect_wrist_camera:
            if self.single_arm_mode:
                res["wrist_camera"] = {"rgba": _get_rgba(self.wrist_camera)}
            else:
                res["left_camera"] = {}
                res["right_camera"] = {}
    ...
    def get_segmentation(self, level="mesh") -> dict:
        ...
        if self.collect_wrist_camera:
            if self.single_arm_mode:
                res["wrist_camera"] = {
                    f"{level}_segmentation": _get_segmentation(self.wrist_camera, level=level)
                }
            else:
                res["left_camera"] = {}
                res["right_camera"] = {}
    ...
    def get_depth(self) -> dict:
        ...
        if self.collect_wrist_camera:
            if self.single_arm_mode:
                res["wrist_camera"] = {"depth": _get_depth(self.wrist_camera)}
                res["wrist_camera"]["depth"] *= rgba["wrist_camera"]["rgba"][:, :, 3] / 255
            else:
                res["left_camera"] = {}
                res["right_camera"] = {}
    ...
    def get_pcd(self, if_combine=False):
        ...
        if if_combine:
            ...
            if self.collect_wrist_camera:
                if self.single_arm_mode:
                    combined_pcd = _get_camera_pcd(self.wrist_camera)
                else:
